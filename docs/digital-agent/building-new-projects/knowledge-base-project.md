...
|  |  |  |
| --- | --- | --- |
|  | Learn how to add your first 'Message' node and 'Answer' node to your logic |  |
|  | Start using the capabilities of 'AI' node and how can you implement it to your logic |  |
|  | See how to train, test and play with current chatbot bubble withou deploying |  |
|  | Learn how to add a Knowledge base index on existing logic in UNESCO use case |  |
