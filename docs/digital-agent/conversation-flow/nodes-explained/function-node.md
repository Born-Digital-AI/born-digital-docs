...
> **INFO:** In this overview, the target node remains empty. Ensure you connect another node after the ['Function' node](../digital-agent/conversation-flow/nodes-explained/function-node.md) to continue the flow effectively.
