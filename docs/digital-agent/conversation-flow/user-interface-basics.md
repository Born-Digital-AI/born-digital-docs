...
- Settings: Allows you to customize project settings and configurations according to your preferences. See  for detail explanation.
...
> **INFO:** You can see that we can expand the chatbot widget or move it to the middle by clicking the buttons in the top left corner
